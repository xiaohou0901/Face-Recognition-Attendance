...
#include "../../AttendanceServer/qfaceobject.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QFaceObject_t, stringdata0) + ofs \
...
static const uint qt_meta_data_QFaceObject[] = {
...
QT_INIT_METAOBJECT const QMetaObject QFaceObject::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QFaceObject.data,
    qt_meta_data_QFaceObject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QFaceObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QFaceObject.stringdata0))
